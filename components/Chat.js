...
const styles = {
	bullishLabel: `flex cursor-pointer active:bg-green-600 items-center text-green-600 border-green-600 h-min px-2 rounded-lg`,
...
const Chat = () => {
	...
	return (
		<>
				...
				<div className={styles.chatContainer}>
                  ...
                  height={70}
							...
							<div className="text-left mr-10">
								<strong className="text-gray-400">Seth</strong>
								<p>@sethmwebi</p>
							</div>
						</div>
			...
			<input className={styles.input} placeholder="What's happening on BTC?" value={message} onChange={e => setMessage(e.target.value)}/>
